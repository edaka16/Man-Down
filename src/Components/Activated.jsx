  ...
  return (
    ...
    <div className={classes.root}>
      ...
      <main className={classes.content}>
        <div className={classes.toolbar} />
        <Typography paragraph className={classes.crashDetection}>
        Crash Detection Status
        </Typography>
        <Typography variant="h6" noWrap className={classes.active}>
          ACTIVATED
        </Typography>
        <Divider />
        ...
        <Grid item xs={6}>
          <Paper className={classes.manual}>CANCEL</Paper>
        </Grid>
        <Grid item xs={6}>
        <Button onClick={(e)=>{ history.push("/crashDetection")}} className="alarm">MANUAL ALARM</Button>
        </Grid>
      </Grid>
      </div>
      </main>
